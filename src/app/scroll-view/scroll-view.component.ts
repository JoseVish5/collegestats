...
export class ScrollViewComponent implements AfterViewInit {
  items = [
    ...
    { title: '', description: 'Along with an incline of 11% points since 2013, there was a drastic increase in the number of male students enrolling in computer engineering courses, from about 3.5 lakh in 2013 to 8.25 lakh in 2023. ', image: 'e6.png' },
    { title: '', description: 'Male students are also cominating in newly introduced courses such as data science, where they make up 78.3% of the total number of students enrolled, and Artifical Intelligence, where they formed 70%.', image: 'e7.png' },
    ...
    { title: '', description: 'They lacked a presence in courses such as marine engineering and mining engineering, where they formed less than one percent of the student enrolments.', image: 'e10.png' },
    { title: 'The share of female students across various engineering courses in 2022', description: '', image: 'e11.png' },
    { title: '', description: 'Despite continuing to enroll for core courses such as computer engineering and information technology, the presence of female students in these disciplines dropped by some 10% points each, as the decade progressed. ', image: 'e12.png' },
    ...
    { title: '', description: 'The share of female students also increased significantly in mechanical engineering and civil engineering, from 4.2% to 7.6% and 18.2% to 23%, respectively, in the same period.', image: 'e14.png' },
  ...
  onContainerScroll() {
    ...
    itemElements.forEach((element: HTMLElement, index: number) => {
      if (element.offsetTop <= scrollPosition + window.innerHeight / 0.5 && element.offsetTop + element.clientHeight > scrollPosition + window.innerHeight / 1) {
